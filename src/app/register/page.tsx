...
import { TextField, Button, Link as MuiLink, Typography} from '@mui/material';
...
export default function RegisterPage() {
  ...
  return (
    ...
    <Typography variant="h4" gutterBottom>
          {/* Your logo image */}
          <img src="/sou-logo2.png" alt="Logo" className="w-17 h-20"/>
    </Typography>
    ...
    <Typography variant="h4" gutterBottom>
          {/* Your logo image */}
          <img src="Slider-Images/1.webp" alt="Logo" className="w-full h-full"/>
    </Typography>
    </div>
